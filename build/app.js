  ...
  _loadHeader: function() {
    return (
      React.createElement("div", {className: "header__container"}, 
        React.createElement("h1", null, React.createElement("a", {href: "/", "data-js": "pageTitle"}, "HexMex")), 
        React.createElement("h2", null, "...live colourfully...")
      )
    )
  },
...
},{"./Palettes.react":162,"director":4,"react":159}],161:[function(require,module,exports){
var React = require('react');
...
var Palette = React.createClass({displayName: "Palette",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "palettes__main"}, 
        tempTitle
      )
    );
  },
  ...
  _listPalettes: function() {
    ...
    return allPalettes.map(function(item) {
      return (
        React.createElement("div", {className: "palette__container", key: item.id}, 
  ...
  _listPaletteColors: function(p) {
    ...
    var paletteColours = colourKeys.map(function(colKey, i) {
      ...
      return (
        React.createElement("div", {className: "palette__colour", key: p.id + colKey, style: {backgroundColor: p.colours[colKey]}}, 
          React.createElement("div", {className: "palette__colourHex"}, p.colours[colKey]), 
          React.createElement("div", {className: "palette__colourType"}, newKey)
        )
      )
    });
    return (
      React.createElement("div", {className: "palette__colourContainer"}, 
        paletteColours
      )
    )
  },
  ...
  _generatePaletteTitle: function(item) {
    ...
    return (
      React.createElement("div", {className: "palette__title"}, 
        React.createElement("div", null, item.title, " | ", item.category, 
  ...
  _generateNavLink: function(item) {
    if (this.props.detailed === true) {
      return (
        React.createElement("a", {href: '/', "data-js": "titleHref"}, " | return to all palettes")
      )
    } else {
      return (
        React.createElement("a", {href: '/palettes/' + item.id, "data-js": "titleHref"}, " | see details")
      )
    }
  },
  ...
  _includeDetails: function(item) {
    if (this.props.detailed === true) {
      return (
        React.createElement("div", {className: "palette__details"}, 
          React.createElement("ol", null, 
            React.createElement("li", null, "Palette Title: ", item.title), 
            React.createElement("li", null, "Palette Category: ", item.category), 
            React.createElement("li", null, "Palette Creator/Owner: ", item.user.name)
          )
        )
      )
    };
...
var Palettes = React.createClass({displayName: "Palettes",
  propTypes: {
    ...
    return (
      React.createElement("div", {className: "palettes__main"}, 
        self.props.palettes.map(function(item) {
          return React.createElement(Palette, {palette: item, key: item, detailed: self.props.detailed});
        })
      )
    )
  },
